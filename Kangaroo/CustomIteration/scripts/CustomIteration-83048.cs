...
/// </summary>
public abstract class Script_Instance_83048 : GH_ScriptInstance
{
  ...
  /// </summary>
  #region Runscript
  private void RunScript(List<object> x, ref object A, ref object B)
  {
    ...
    do
    {
      ...
      counter++;
    }while(PS.GetvSum() > threshold && counter < 100); //GetvSum returns the current kinetic energy
